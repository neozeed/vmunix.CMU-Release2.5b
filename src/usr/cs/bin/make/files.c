#ifndef lint
static char *RCSid = "$Header: files.c,v 5.1 89/04/13 20:45:36 bww Exp $";
#endif
...
/*
 * CMUCS has a modified lib/cpp that uses MAKECPP to
 * handle include files correctly, otherwise we lose
 * the distinction between <> and "" style includes.
 */
#ifdef CMUCS
int hasmakecpp		= 1;
#else
int hasmakecpp		= 0;	/* patch me */
#endif
